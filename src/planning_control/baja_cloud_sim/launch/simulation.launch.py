...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(package="baja_cloud_sim", executable="gz_pcl_bridge", name="gz_pcl_bridge", parameters=[{"use_sim_time": True}], output="screen"),
        ...
        # Provides /obstacle_markers (obstacle_adapter) to the planning & control core.
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={"use_rviz": "false", "perception_mode": "truth"}.items(),
        ),
    ])
